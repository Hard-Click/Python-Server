...
## 구조
- `scheduler/` — OR-Tools CP-SAT 기반 주간 강의 배정 (`generate_weekly_schedule`)
- `review/` — 퀴즈점수 → FSRS grade 매핑 + 복습카드 갱신 (`review_lesson`)
- `dropout/` — 이탈위험 규칙기반 스코어 (콜드스타트, 이후 Cox PH로 승급 예정)
